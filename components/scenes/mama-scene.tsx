...
const message2Video = videoFondos.mama;
const mamaName = event.parents.mother;

interface MamaSceneProps {
  onComplete: () => void
  isActive: boolean
}

export function MamaScene({ onComplete, isActive }: MamaSceneProps) {
