            ...
            {firstTextComplete && (
              <div className="mb-6">
                <TypewriterText 
                  text={secondMessage}
                  delay={80}
                  className="text-4xl md:text-5xl text-amber-500 italic"
            ...
            {secondTextComplete && (
              <div className="mb-6">
                <TypewriterText 
                  text={thirdMessage}
                  delay={100}
                  className="text-4xl md:text-5xl font-bold text-amber-500 italic"
            ...
            {thirdTextComplete && (
              <div className="mb-6">
                <TypewriterText 
                  text={fourthMessage}
                  delay={60}
                  className="text-4xl md:text-5xl text-amber-500 italic leading-relaxed"
