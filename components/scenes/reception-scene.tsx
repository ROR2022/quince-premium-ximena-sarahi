            ...
            <div className="space-y-8">
              ...
              <div className="animate-fade-in">
                <button
                  ...
                  className="bg-gradient-to-r from-pink-500 via-pink-600 to-pink-700 text-amber-500 font-bold px-12 py-6 rounded-full text-2xl md:text-3xl shadow-2xl transform hover:scale-105 transition-all duration-300 hover:shadow-pink-500/50"
                >
