      ...
      >
        ...
        <div className="mb-12">
          ...
          className={`transition-all duration-1000 delay-0 ${
            ...
            <div className="inline-block text-sky-800 px-4 py-2 rounded-full text-sm font-medium mb-6 shadow-lg" style={{ background: 'linear-gradient(to right, #e3aaaa, #d49999)' }}>
              📸 Galería
            </div>
          </div>
